                ...
                <div class="header__inner">
                    ...
                    <nav class="navbar">
                        <ul>
                            ...
                            <li><a href="/client.html">Для клиентов</a></li>
            ...
            >
                <div class="container">
                    <div class="prodIn_hero">
                        <h2>GS8</h2>
                        <p>7-местный флагманский кроссовер</p>
                    </div>
                </div>
            </section>
                ...
                <div class="swiper mySwiper">
                    <div class="swiper-wrapper">
                        <div
                            class="swiper-slide"
                            style="
                                background: url('./img/heroBg.jpg') center/cover
                                    no-repeat;
                            "
                        ></div>
            ...
            <section
                ...
                style="
                    background: linear-gradient(
                        ...
                        url('./img/formBg.jpg') center / cover no-repeat;
                "
            >
                <div class="container">
                    ...
                    <div class="footer_top">
                        <div>
                            ...
                            <ul>
                                ...
                                <li><a href="/product.html">Продукты</a></li>
                                <li>
                                    <a href="/tecnology.html">Технологии</a>
                                </li>
                                <li><a href="/client.html">Для клиентов</a></li>
                                <li><a href="/news.html">Новости</a></li>
                                <li><a href="/media.html">Медиа</a></li>
                            ...
                            <a href="">
                                ...
                                >
                                    <rect
                                        width="241"
                                        height="51"
                                        fill="url(#pattern0_11024_1106)"
                                    />
                                    <defs>
                                        <pattern
                                            id="pattern0_11024_1106"
                                            patternContentUnits="objectBoundingBox"
                                            width="1"
                                            height="1"
                                        >
                                            <use
                                                xlink:href="#image0_11024_1106"
                                                transform="matrix(0.000900901 0 0 0.0042572 0 -0.00447801)"
                                            />
                                        </pattern>
                                        <image
                                            id="image0_11024_1106"
                                            width="1110"
                                            height="237"
